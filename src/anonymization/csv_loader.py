...
REQUIRED_COLUMNS: Dict[str, List[str]] = {
    ...
    "customer_master": [
        ...
        "account_status", "kyc_status", "country", "created_at"
    ],
    "consent_records": [
        "consent_id", "customer_id", "tenant_id", "consent_status", 
        "consent_date", "expiry_date", "consented_purpose", "consent_version", 
        "notice_provided", "is_bundled", "consent_channel", "guardian_consent_id"
    ],
    "transaction_events": [
...
DROP_COLUMNS: Dict[str, List[str]] = {
    ...
    "consent_records": ["withdrawal_date"],
    "system_inventory": ["third_party_integrations"],
